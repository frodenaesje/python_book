...
# TODO: add more algorithms, ref exercise text
ALGORITHMS = [
    "insertion_sort",
    "merge_sort"
]
...
def theoretical_time(algorithm, n):
    ...
    """
    # TODO
    # return n * n, n * math.log(n), etc. based on algorithm name
    # return n if unknown algorithm, to avoid zero division in scaling
    return n # placeholder, to be replaced with actual theoretical time based on algorithm
