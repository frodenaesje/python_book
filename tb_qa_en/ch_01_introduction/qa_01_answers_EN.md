...
**2. LIFO structure**
LIFO stands for Last In, First Out — the last item placed in is the first to be taken out. A stack of plates is a good everyday example: we always take from the top.
...
**10. Integer division `//` and modulo `%`**
```
...
**12. The `add()` function with different types**
```python
